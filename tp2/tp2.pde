...
void draw () {
  ...
  println("tiempo =", tiempo, "/", "triger=", "/inicio=", inicio, "escena1=", escena1, "escena2=", escena2, posx11);
  ...
  if (tiempo >= 0) {
    ...
    if (inicio==true) {
      ...
      //      posy8 -=10;
      //      image(cartelrosewood, posx12, posy8, 370, 70);
      //    }
      //    if (posy9 != 170) {
      //      image(rosewood, posx12, posy7, 490, 266);

      //      if (posy8 == 110) {
      //        image(cartelrosewood, posx12, posy9, tamx4, tamy3);
      //      }
